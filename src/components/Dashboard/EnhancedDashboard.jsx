...
export default function EnhancedDashboard() {
  ...
  <motion.div
    ...
    style={{ fontFamily: "Arial, sans-serif" }}
  >
    <div className="flex items-start justify-between bg-blue-100 border border-blue-600 rounded-md p-1.5">
      <div className="min-w-0">
        <p className="text-xs font-semibold text-gray-900 uppercase tracking-wide truncate">
          Total Employees
        </p>
        <motion.p
          initial={{ opacity: 0, scale: 0.5 }}
      ...
      <div className="w-8 h-8 sm:w-9 sm:h-9 bg-blue-300 rounded-lg flex items-center justify-center flex-shrink-0">
        <svg
    ...
    <div className="pt-2 border-t border-gray-100 mt-2">
      <span className="inline-flex items-center text-[11px] text-blue-500 font-bold">
        <span className="w-1.5 h-1.5 bg-blue-500 rounded-full mr-1.5"></span>
        All active employees
      </span>
    </div>
  ...
  <motion.div
    ...
    style={{ fontFamily: "Arial, sans-serif" }}
  >
    <div className="flex items-start justify-between bg-green-100 border border-green-500 rounded-md p-1.5">
      <div className="min-w-0">
        <p className="text-xs font-semibold text-gray-900 uppercase tracking-wide truncate">
          Present Today
        </p>
      ...
      <div className="w-8 h-8 sm:w-9 sm:h-9 bg-green-300 rounded-lg flex items-center justify-center flex-shrink-0">
        <svg
    ...
    <div className="pt-2 border-t border-gray-100 mt-2">
      <span className="inline-flex items-center text-[11px] text-emerald-600 font-bold">
  ...
  <motion.div
    ...
    style={{ fontFamily: "Arial, sans-serif" }}
  >
    <div className="flex items-start justify-between bg-red-100 border border-red-600 rounded-md p-1.5">
      <div className="min-w-0">
        <p className="text-xs font-semibold text-gray-900 uppercase tracking-wide truncate">
          On Leave Today
        </p>
        <motion.p
          ...
          animate={{ opacity: 1, scale: 1 }}
          transition={{ delay: 0.5 }}
          className="text-lg font-bold text-rose-600 mt-1"
        >
          {stats.todayAbsent}
        </motion.p>
      </div>

      <div className="w-8 h-8 sm:w-9 sm:h-9 bg-rose-300 rounded-lg flex items-center justify-center flex-shrink-0">
        <svg
    ...
    <div className="pt-2 border-t border-gray-100 mt-2">
      <span className="inline-flex items-center text-[11px] text-red-500 font-bold">
        Requires attention
      </span>
    </div>
  </motion.div>
  ...
  <motion.div
    ...
    style={{ fontFamily: "Arial, sans-serif" }}
  >
    <div className="flex items-start justify-between bg-amber-100 border border-amber-500 rounded-md p-1.5">
      <div className="min-w-0">
        <p className="text-xs font-semibold text-gray-900 uppercase tracking-wide truncate">
          Attendance Rate
        </p>
    ...
    <div className="pt-2 border-t border-gray-100 mt-2 font-bold">
